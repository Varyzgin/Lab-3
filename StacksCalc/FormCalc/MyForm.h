...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(92, 63);
			this->button1->Margin = System::Windows::Forms::Padding(2);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(64, 28);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F));
			...
			this->textBox3->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F));
			this->textBox3->Location = System::Drawing::Point(71, 96);
			...
			this->textBox1->Text = L"2+ 3- (4 ^5)";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(249, 127);
			...
			this->MinimumSize = System::Drawing::Size(265, 166);
			this->Name = L"MyForm";
			this->Text = L"MyForm";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		calc.SetExpr(infix);
		calc.ToPostfix();
		textBox2->Text = msclr::interop::marshal_as<String^>(calc.GetPostfix());
		textBox3->Text = Convert::ToString(calc.CalcPostfix());
	}
	};
}
